                    ...
                    <tbody>
                        <c:forEach items="${datos}" var="dato">
                            <tr>
                                ...
                                <td>
                                    <a href="<c:url value="edit.htm?id=${dato.idusuarios}"/>"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>Editar</a>
                                    <a href="<c:url value="delete.htm?id=${dato.idusuarios}"/>"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span>Eliminar</a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
